            ...
            <div class="col">
              <div class="slider-area mr-15">
                <div class="slider-active-5 dot-style-6 dot-style-6-position-1">
                  <div
                    class="single-slider slider-height-13 custom-d-flex custom-align-item-center bg-img"
                    style="
                      background-image: url(/images/slider/turntable.jpg);
                    "
                  >
                    <div class="container">
                      <div class="slider-content-12 slider-animated-1">
                        <h1 class="animated">
                          Build <br /><span class="bold">E-commerce</span>
                          <br /><span class="blue">Mega</span> Store
                        </h1>
                        <p class="animated">
                  ...
                  <div
                    class="single-slider slider-height-13 custom-d-flex custom-align-item-center bg-img"
                    style="
                      background-image: url(/images/slider/fashion-store.jpg);
                    "
                  >
                    <div class="container">
                      <div class="slider-content-12 slider-animated-1">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                  <div class="product-wrap mb-40">
                    ...
                    <div class="product-content">
                      <h4><a href="produk">Product Title</a></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
              <div class="card border-0 shadow">
                <div class="card-body d-flex align-items-center">
                  <img
                    class="card-icon"
                    src="/images/icon-img/box.svg"
                    style="width: 30%"
                  />
                  <div class="ml-0 pl-0">
                    <h3 class="card-title mb-0">Gratis Ongkir</h3>
                    <p class="card-text">
                      Gratis ongkir untuk pesanan lebih dari Rp.50k
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
              <div class="card border-0 shadow">
                <div class="card-body d-flex align-items-center">
                  <img
                    class="card-icon"
                    src="/images/icon-img/moneyback.svg"
                    style="width: 30%"
                  />
                  <div class="ml-0 pl-0">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
              <div class="card border-0 shadow">
                <div class="card-body d-flex align-items-center">
                  <img
                    class="card-icon"
                    src="/images/icon-img/secure.svg"
                    style="width: 30%"
                  />
                  <div class="ml-0 pl-0">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
              <div class="card border-0 shadow">
                <div class="card-body d-flex align-items-center">
                  <img
                    class="card-icon"
                    src="/images/icon-img/support.svg"
                    style="width: 30%"
                  />
                  <div class="ml-0 pl-0">
