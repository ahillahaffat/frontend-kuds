            ...
            <div class="row align-items-center">
              <div class="col-6">
                <div class="mobile-logo mobile-logo-width">
                  <a href="index.html">
                    <img alt="" src="/images/logo/kuds1.png" />
                  </a>
                </div>
              </div>
              <div class="col-6">
              ...
              <div class="checkout-left-wrap">
                <div class="login-guest-top">
                  <div class="checkout-tab nav">
                    <a href="#checkout-login" data-toggle="tab"> Alamat </a>
                ...
                <div class="payment-method">
                  <div class="pay-top sin-payment">
                    <input
                      ...
                      name="payment_method"
                    />
                    <label for="payment_method_1"> LinkAja </label>
                    <div class="payment-box payment_method_bacs">
                      <form action="#">
                        <input
                          type="text"
                          required=""
                          placeholder="Enter Your LinkAja, Email"
                          name="name"
                        />
                      </form>
                    </div>
