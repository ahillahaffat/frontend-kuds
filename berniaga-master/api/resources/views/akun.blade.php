...
<html class="no-js" lang="en">
  <head>
    ...
    <title>KUDS Market | User Profile</title>
    ...
    <script src="{{ ('css/edit-address.js') }}"></script>
    <script src="{{ ('css/showandhide.js') }}"></script>
  ...
  <header
        class="header-area section-padding-1 header-ptb-1 transparent-bar sticky-bar"
      >
          ...
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-lg-0 col-md-0">
                <div class="logo">
                  <a href="index">
                    <img src="/images/logo/kuds1.png" alt="logo" />
                  </a>
                </div>
              </div>
              <div class="col-xl-11">
                <div
                  class="header-action-wrap header-action-flex header-action-mrg-2"
                >
            ...
            <div class="row align-items-center">
              <div class="col-6">
                <div class="mobile-logo mobile-logo-width">
                  <a href="index">
                    <img alt="" src="/images/logo/untitled-5.png" />
                  </a>
                </div>
              </div>
              <div class="col-6">
        ...
        <div class="clickalbe-sidebar-wrap">
          ...
          <div class="mobile-menu-content-area sidebar-content-100-percent">
                  ...
                  <li class="has-sub-menu">
                    ...
                    <ul class="sub-menu-2">
                      <li class="has-sub-menu">
                        ...
                        <ul class="sub-menu-2">
                          <li><a href="index">Home Multipurpose</a></li>
                          <li>
                            <a href="index-megashop.html">Home Mega Shop</a>
                          </li>
                          ...
                          <li>
                            <a href="index-automobile.html">Home Automobile</a>
                          </li>
                          <li>
                            <a href="index-furniture.html">Home Furniture</a>
                          </li>
                          <li>
                            <a href="index-electric.html">Home Electric</a>
                          </li>
                        </ul>
                      </li>
                      <li class="has-sub-menu">
                        ...
                        <ul class="sub-menu-2">
                          <li>
                            <a href="index-electric-2.html">Home Electric 2</a>
                          </li>
                          <li>
                            <a href="index-handcraft.html">Home Hand Craft</a>
                          </li>
                      ...
                      <li class="has-sub-menu">
                        ...
                        <ul class="sub-menu-2">
                          ...
                          <li>
                            <a href="index-treeplant.html">Home Tree plant</a>
                          </li>
                          <li>
                            <a href="index-pet-food.html">Home Pet Food</a>
                          </li>
                    ...
                    <ul class="sub-menu-2">
                      <li class="has-sub-menu">
                        ...
                        <ul class="sub-menu-2">
                          ...
                          <li>
                            <a href="shop-list.html">Shop List Style 1</a>
                          </li>
                          <li>
                      ...
                      <li class="has-sub-menu">
                        ...
                        <ul class="sub-menu-2">
                          <li>
                            <a href="product-details.html">Product Layout 1</a>
                          </li>
                          <li>
            ...
            <div class="mobile-curr-lang-wrap">
              <div class="single-mobile-curr-lang">
                <a class="mobile-language-active" href="#"
                  >Language <i class="icofont-simple-down"></i
                ></a>
            ...
            <div class="aside-contact-info">
              <ul>
                <li>
                  <i class="icofont-clock-time"></i>Monday - Friday: 9:00 -
                  19:00
                </li>
                <li><i class="icofont-envelope"></i>Info@example.com</li>
                <li><i class="icofont-stock-mobile"></i>(+55) 254. 254. 254</li>
                <li>
                  <i class="icofont-home"></i>Helios Tower 75 Tam Trinh Hoang -
                  Ha Noi - Viet Nam
                </li>
              </ul>
            </div>
      ...
      <div class="my-account-wrapper bg-gray pt-50 pb-160">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="myaccount-tab-menu nav" role="tablist">
                      <a href="#dashboad" class="active" data-toggle="tab"
                        >Informasi Umum</a
                      >
                      <a href="#address-edit" data-toggle="tab">Alamat Pengiriman</a>
                    ...
                    <div class="tab-content" id="myaccountContent">
                      ...
                      >
                        <div class="myaccount-content">
                          ...
                          <div class="welcome">
                            <div class="profile-wrapper">
                              <div class="profile-icon">
                                ...
                                <img src="avatar(1).png" alt="Profile Icon" />
                          ...
                          <p class="mb-0">
                            ...
                            billing addresses, and edit your password and
                            account details.
                          </p>
                      ...
                      >
                        <div class="myaccount-content">
                          ...
                          <a href="#" class="check-btn sqr-btn edit-address-btn"
                            ><i class="fas fa-edit"></i> Edit Address</a
                          >
                        </div>
                      </div>
                      <div
                      ...
                      >
                        <div class="myaccount-content">
                          ...
                          <form id="edit-address-form">
                            ...
                            <div class="form-group">
                              <label for="edit-kodepos">Kode Pos</label>
                              <input
                                type="text"
                                class="form-control"
                                id="edit-kodepos"
                            ...
                            <div class="form-group">
                              <label for="edit-telepon">Nomor Telepon</label>
                              <input
                                type="tel"
                                class="form-control"
                                id="edit-telepon"
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>$3000</td>
                                <td>
                                  <a href="cart.html" class="check-btn sqr-btn"
                                    >View</a
                                  >
                                </td>
                              </tr>
